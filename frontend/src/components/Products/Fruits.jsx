...
const ProductCard = ({ data }) => {
    ...
    return (
        <div className="w-fit flex items-center rounded-xl border border-solid border-gray-900">
            <img className='w-[12.5rem] aspect-auto object-cover rounded-l-xl' src={data.productImg} alt="" />
            <div className="w-fit h-fit p-4 flex flex-col items-start justify-between border-l-0 rounded-r-xl">
                <div className="w-full flex flex-col items-start">
                    ...
                    <div className="w-full flex flex-col items-start gap-1 py-4">
                        <div className="cursor-pointer w-full flex items-center justify-start gap-2">
                            {
                                clicked || quantity === data.discount[1] ?
                        ...
                        <div className="cursor-pointer w-full flex items-center justify-start gap-2">
                            {
                                clicked1 || quantity === data.discount1[1] ?
                ...
                <button disabled={clicked || clicked1} className='flex items-center justify-center gap-3 border-2 boreder-solid border-gray-900 text-gray-900 font-semibold py-2 px-3 rounded-md'>
