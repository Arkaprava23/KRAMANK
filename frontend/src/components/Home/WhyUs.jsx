...
const WhyUs = () => {
    return (
        <div className="w-full h-fit flex flex-col items-center m-16">
            ...
            <div className='flex flex-wrap items-center justify-center gap-6 lg:gap-16 py-4'>
                <div className="w-[80%] lg:w-fit py-12 px-28 flex flex-col items-center gap-1 rounded-xl shadow-[#FFD700_0px_6px_12px_-2px,rgba(0,0,0,0.3)_0px_3px_7px_-3px]">
