            ...
            <div className="hidden lg:flex items-center justify-center gap-6">
                {
                    isUserLoggedIn ?
                        ...
                        :
                        <button className={`py-2 px-6 rounded-[2rem] font-semibold ${scrolling ? 'bg-gray-900 hover:bg-gray-800 text-white' : 'bg-white hover:bg-blue-gray-100 text-gray-900'}`} onClick={() => navigate("/login")}>
                            login / signup
                        </button>
                }
            </div>
